...
static void airport_prog_1(struct svc_req *rqstp, register SVCXPRT *transp) {
	union {
		Target closestairports_1_arg;
	} argument;
	char *result;
	...
	case closestAirports:
		_xdr_argument = (xdrproc_t) xdr_Target;
		_xdr_result = (xdrproc_t) xdr_SearchResult;
		local = (char *(*)(char *, struct svc_req *)) closestairports_1_svc;
		break;
