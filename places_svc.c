...
places_prog_1(struct svc_req *rqstp, register SVCXPRT *transp)
{
	...
	case placesQuery:
		_xdr_argument = (xdrproc_t) xdr_ClientRequest;
		_xdr_result = (xdrproc_t) xdr_PlacesResult;
		local = (char *(*)(char *, struct svc_req *)) placesquery_1_svc;
		break;
...
char* airportsHost = NULL;

int
main (int argc, char **argv)
{
	if(argc < 2) {
		printf("usage: %s airports_host\n", argv[0]);
		exit(1);
	}
